...
- (void)viewDidLoad {
    ...
    KSWebViewScriptHandler *testJSCallback = [[KSWebViewScriptHandler alloc]initWithTarget:self action:@selector(webViewScriptHandlerTestJSCallbackWithMessage:)];
...
-(void)layoutWebView:(KSWebView *)webView {
    ...
    scrollView.contentInset = (UIEdgeInsets){top,0.f,0.f,0.f};//复杂的webview中不建议设置此项会影响H5的布局
}
